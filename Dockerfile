...
RUN Rscript -e "devtools::install_github(c('hemberg-lab/scRNA.seq.funcs', 'Vivianstats/scImpute', 'theislab/kBET', 'JustinaZ/pcaReduce', 'tallulandrews/M3Drop', 'jw156605/SLICER', 'kieranrcampbell/ouija', 'sinhrks/ggfortify', 'nghiavtr/BPSC', 'dviraran/SingleR', 'statOmics/zingeR', 'dviraran/xCell', 'drisso/zinbwave', 'vqv/ggbiplot', 'thomasp85/gganimate@v0.1.1'))"
